 ...
 * No comment to comments, only to posts.
 *
 * @param currentUser is the author of the comment
 * @param postId id of the post being commented
 * @param onNewComm update post mutation
 * @param isAdmin true if author is admin
 * @param setModerate
 * @param setTarget
 * @returns {JSX.Element}
 * @constructor
